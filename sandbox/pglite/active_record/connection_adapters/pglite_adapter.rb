...
# as it stands there.  What this sandbox needs on top of it -- the array types,
# the array encoder the pg stub does without, the adapter registration Rails
# 7.2 and later want, and the exception translation -- is in pglite.rb beside
# this file, so that a newer copy can be dropped in whole.
